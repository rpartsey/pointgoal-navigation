...
LOG_DIR="/home/rpartsey/code/3d-navigation/related_works/egolocalization/out/ddppo/experiments/${EXP_NAME}"
CHKP_DIR="/home/rpartsey/code/3d-navigation/related_works/egolocalization/out/ddppo/checkpoints/${EXP_NAME}"
