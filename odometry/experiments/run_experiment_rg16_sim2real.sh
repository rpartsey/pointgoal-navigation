...
#SBATCH --error=/checkpoint/maksymets/logs/habitat_baselines/ddppo/pointgoal_nav/fair_sim2real_regnety016_bs32_rgbd_actemb2_flip_invrot/log.err
...
srun python -u -m train_odometry_v2 --config-file config_files/odometry/paper/sim2real/fair_sim2real_regnety016_bs32_rgbd_actemb2_flip_invrot.yaml
