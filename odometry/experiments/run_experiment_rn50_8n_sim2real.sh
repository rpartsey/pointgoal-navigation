...
#SBATCH --output=/checkpoint/maksymets/logs/habitat_baselines/ddppo/pointgoal_nav/fair_sim2real_resnet50_bs32_rgbd_actemb2_flip_invrot/log.out
#SBATCH --error=/checkpoint/maksymets/logs/habitat_baselines/ddppo/pointgoal_nav/fair_sim2real_resnet50_bs32_rgbd_actemb2_flip_invrot/log.err
